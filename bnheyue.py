              ...
              'LUMIA/USDT','DF/USDT','PHA/USDT','ZEREBRO/USDT','AI16Z/USDT',
               'GRIFFAIN/USDT','BIO/USDT','SWARMS/USDT','ALCH/USDT','COOKIE/USDT',
                'PROM/USDT','SOLV/USDT','AVAAI/USDT','ARC/USDT','TRUMP/USDT',
                 'MELANIA/USDT','ANIME/USDT','PIPPIN/USDT','VVV/USDT','BERA/USDT'
                 ,'TST/USDT','1000CHEEMS/USDT','LAYER/USDT','HEI/USDT','B3/USDT','IP/USDT']
...
for i in symbols_list:
    ...
    time.sleep(0.1)
    fudu = (bars[-1][-2] - bars[0][-2]) / bars[4][-2] * 100  # 转换为百分比
