...
# 
expected_memory_locators = ['DIMM000', 'DIMM010', 'DIMM020',  'DIMM050', 'DIMM060', 'DIMM070',
                            'DIMM100', 'DIMM110', 'DIMM120',  'DIMM140', 'DIMM150', 'DIMM160']

# expected_memory_locators = ['DIMM000',   'DIMM020',   'DIMM040',   'DIMM060',    'DIMM100' , 'DIMM120',    'DIMM140',   'DIMM160' ]
expected_memory_check_dict = {
    'expected_memory_counts': 12,  # 安装内存的条数
...
expected_psu_check_dict = {
    ...
    'expected_psu_fw': 'DC:101 PFC:101',
    'expected_psu_model': 'PAC900S12-B2',
    'expected_psu_watts': 900
}

expected_pcie_check = True
expected_pcie_installed_number = 5
expected_pcie_check_dict = {

    'PCIeCard1': True,
    'PCIeCard1_Description': 'MT27800 Family [ConnectX-5]',
    'PCIeCard1_FirmwareVersion': '16.26.2002',
    'PCIeCard1_DeviceLocator': 'MCX512A-ACUT',

    #
    'PCIeCard2': True,
    'PCIeCard2_Description': 'MT27800 Family [ConnectX-5]',
    'PCIeCard2_FirmwareVersion': '16.26.2002',
    'PCIeCard2_DeviceLocator': 'MCX512A-ACUT',
    #
     'PCIeCard3': True,
    'PCIeCard3_Description': 'MT27800 Family [ConnectX-5]',
    'PCIeCard3_FirmwareVersion': '16.26.2002',
    'PCIeCard3_DeviceLocator': 'MCX512A-ACUT',

    'PCIeCard4': False,
    'PCIeCard4_Description': ' Family [ConnectX-5]',
    'PCIeCard4_FirmwareVersion': '16..2006',
    'PCIeCard4_DeviceLocator': 'MCX51A-ACUT',

    'PCIeCard5': True,
    'PCIeCard5_Description': 'MT27800 Family [ConnectX-5]',
    'PCIeCard5_FirmwareVersion': '16.26.2002',
    'PCIeCard5_DeviceLocator': 'MCX512A-ACUT',

    'PCIeCard6': True,
    'PCIeCard6_Description': 'MT27800 Family [ConnectX-5]',
    'PCIeCard6_FirmwareVersion': '16.26.2002',
    'PCIeCard6_DeviceLocator': 'MCX512A-ACUT',
