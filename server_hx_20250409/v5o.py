...
# login_pwd
# login_button_submit
el = wait.until(EC.presence_of_element_located(('id','login_name')))

driver.find_element('id','login_name').send_keys(username)
# element_username.send_keys('Administrator')
driver.find_element('id','login_pwd').send_keys(password)
# element_password.send_keys('Admin@9000')
#
driver.find_element('id','login_button_submit').click()
