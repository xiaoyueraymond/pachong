...
class BitgetTrader:
    def __init__(self, bSymbolPathExists=False, pathSymbol="/home/your_username/python/appifyers/symbols.csv"):
    ...
    def CreateExchange(self):
        with open('/home/your_username/python/appifyers/configuration.json', 'r') as f:
            data = json.load(f)
        return bit2.bitget({
            'apikey': data["APIKEY"],
            'secret': data['SECRET'],
    ...
    def SaveSymbols(self, symbols):
        ...
        print("Symbols have been saved to {}".format(self.pathSymbol))
